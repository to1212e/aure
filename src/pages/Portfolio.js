...
import calcuImage2 from './img/Screenshot 2024-07-11 102143.png';
import jao3Image from './img/Screenshot 2024-07-11 112025.png';
import jao4Image from './img/IMG_20240708_135420_725.jpg';
import jao5Image from './img/Screenshot (136).png';
import AOS from 'aos';
...
const projects = [
  ...
  { img: jao4Image, title: "Front End Project" },
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-8 mt-5">
              <p ref={textRef} id="text" className="text-black">The initiation of the project was catalyzed by the specific task delegated to us by our
          ...
          <div className="row">
            ...
            <div className="col-8 mt-5">
              <p ref={textRef} id="text" className="text-black">This Portfolio project holds significant importance as it aligns with the grading criteria
          ...
          <div className="row">
            ...
            <div className="col-8 mt-5">
              <p ref={textRef} id="text" className="text-black">Creating a front-end design for our exam is a crucial task that involves designing the interface
          ...
          <div className="row">
            ...
            <div className="col-8 mt-5">
              <p ref={textRef} id="text" className="text-black">This project serves as our capstone endeavor, focusing on the development and implementation of
